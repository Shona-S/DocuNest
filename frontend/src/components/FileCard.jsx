...
const FileCard = ({ file, onDelete }) => {
  ...
  const handleDelete = async () => {
    if (!window.confirm(`Are you sure you want to delete "${file.originalFilename}"?`)) return;
  ...
  return (
    <>
      <div className="card card-hover p-4 sm:p-6 rounded-2xl bg-[#1b1622] border border-[#2a2535] hover:border-[#3a2f46] transition-all duration-200 shadow-lg">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center min-w-0">
              <button
                ...
                className="text-base sm:text-lg font-medium text-lavender hover:underline mb-2 text-left disabled:opacity-50 block truncate"
      ...
      <PinModal
        ...
        message="Enter your PIN to download this file."
        onSubmit={(pin) => {
