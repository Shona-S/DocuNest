 ...
 */
// Allowed origins for CORS. Add any dev ports the frontend may run on.
const allowedOrigins = [
  "http://localhost:5173", // local Vite dev (older/dev)
  "http://localhost:5174", // local Vite dev (common newer port)
  "https://docunestt.netlify.app", // live frontend
];

// Centralized CORS options so we can reuse for preflight and normal requests
const corsOptions = {
